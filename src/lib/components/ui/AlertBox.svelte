...
{#if ui.alert}
  ...
  <div class="fixed inset-0 z-[100] flex items-center justify-center p-4">
    ...
    <div
      ...
      aria-label={a.title}
      tabindex="-1"
      class="animate-modal-pop relative z-[101] flex w-full max-w-md flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl outline-none dark:border-slate-700 dark:bg-slate-900"
    >
